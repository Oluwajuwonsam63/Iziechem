                        ...
                        <div class="login-page__right wow fadeInRight" data-wow-duration='1500ms' data-wow-delay='500ms'>
                            <div class="login-page__login-box">
                                <div class="login-page__content">
                                    ...
                                    <form method="POST" action="{{ route('update_posts', $posts->id) }}" enctype="multipart/form-data">
                                        @csrf 
                                        ...
                                        <div class="login-page__group">
                                            ...
                                            <div class="login-page__input-box">
                                                ...
                                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $posts->title) }}" required autocomplete="title" autofocus>
                                            ...
                                            <div class="login-page__input-box">
                                                ...
                                                <input id="keywords" type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="{{ old('keywords', $posts->keywords) }}" required autocomplete="keywords" autofocus>
                                            ...
                                            <div class="login-page__input-box">
                                                ...
                                                <input id="meta_desc" type="text" class="form-control @error('meta_desc') is-invalid @enderror" name="meta_desc" value="{{ old('meta_desc', $posts->meta_desc) }}" required autocomplete="meta_desc" autofocus>
                                                @error('Name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="login-page__input-box">
                                                ...
                                                <textarea col='30' rows="10" id="description"  class="form-control" name="description" required autocomplete="description">{{old('description', $posts->description)}}</textarea>
